...
CREATE TABLE IF NOT EXISTS `cities` (
		`city_id` INT(3) NOT NULL PRIMARY KEY AUTO_INCREMENT,`city_name` VARCHAR(30) NOT NULL,`state_id` INT(3) NOT NULL,`state_name` VARCHAR(30) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(NULL,"Hamirpur","14","Himachal Pradesh"),
(NULL,"Hamirpur","34","Uttar Pradesh"),
...
(NULL,"Khammam","2","Andhra Pradesh"),
(NULL,"Khammam","32","Telangana"),
...
(NULL,"Poducherry","27","Poducherry"),
(NULL,"Poducherry","31","Tamil Nadu"),
...
(NULL,"Port Blair","1","Andaman & Nicobar Islands"),
(NULL,"Portblair","1","Andaman & Nicobar Islands"),
